...
<head>
<title>PHP探针 for LTMH一键安装包</title>
...
th{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #3066a6; text-align:left;}
.th_1{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #3066a6; text-align:left;}
.th_2{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #3066a6; text-align:left;}
.th_3{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #3066a6; text-align:left;}
.th_4{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #CCCCCC; text-align:left;}
.th_5{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #CCCCCC; text-align:left;}
.th_6{padding: 3px 6px; font-weight:bold;background:#1c7cce;color:#FFFFFF;border:1px solid #FF6600; text-align:left;}
tr{padding: 0; background:#F7F7F7;}
td{padding: 3px 6px; border:1px solid #b6babb;}
...
.barli_blue{background:#249fcc; height:5px; margin:0px; padding:0;}
...
#ltmhlink {position: absolute; top: 20px; left: 115px; text-align: right; font-weight: bold; color: #06C;}
#ltmhlink a {color: #249fcc; text-decoration: underline;}
...
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <td width="87%" colspan="5"><?php echo $sysInfo['cpu']['model'];?></td>
	  ...
	  <tr>
		<td>内存使用状况<br \><br \><a><font color=red></font></a></td>
		<td colspan="5">
<?php
$tmp = array(
