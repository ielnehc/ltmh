...
src_url=http://downloads.sourceforge.net/project/graphicsmagick/graphicsmagick/1.3.21/GraphicsMagick-1.3.21.tar.gz && Download_src

tar xzf GraphicsMagick-1.3.21.tar.gz 
cd GraphicsMagick-1.3.21
./configure --enable-shared
make && make install
cd ../
/bin/rm -rf GraphicsMagick-1.3.21
