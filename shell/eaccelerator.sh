...
clear
echo "======================================================================="
echo "Install eAcesselerator for LTMH  ,  Written by Andy "
echo "======================================================================="
echo "LTMH is a tool to auto-compile & install Tengine+MySQL+HHVM on Linux "
echo "This script is a tool to install eAccelerator for ltmh "
echo ""
...
wget -c http://soft.hhvm.biz/php/lib/eaccelerator-0.9.5.3.tar.bz2
...
wget -c http://soft.hhvm.biz/php/lib/eaccelerator-0.9.6.1.tar.bz2
...
wget -c http://soft.hhvm.biz/php/lib/eaccelerator-eaccelerator-42067ac.tar.gz
