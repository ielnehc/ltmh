...
echo "========================================================================="
echo "Reset MySQL/MariaDB root Password for LTMP  ,  Written by Andy "
echo "========================================================================="
echo "LTMP is a tool to auto-compile & install Tengine+MySQL+PHP on Linux "
echo "This script is a tool to reset mysql/mariadb root password for ltmp "
