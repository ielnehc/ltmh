...
sed -i 's@^ltmh_dir=.*@ltmh_dir=@' ./options.conf
...
echo 
echo -e "\033[31mYou will uninstall LTMH, Please backup your configure files and DB data! \033[0m"
echo 
...
do
        echo
        read -p "Do you want to uninstall LTMH? [y/n]: " uninstall_yn
